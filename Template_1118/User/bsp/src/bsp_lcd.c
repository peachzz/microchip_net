...
/* 私有类型定义 --------------------------------------------------------------*/
/* 私有宏定义 ----------------------------------------------------------------*/
#define WIDTH_EN_FONT16_CHAR		              8   //16号英文字符宽度
#define HEIGHT_EN_FONT16_CHAR		              16  //16号英文字符高度
#define WIDTH_EN_FONT24_CHAR		              12  //24号英文字符宽度 
#define HEIGHT_EN_FONT24_CHAR		              24  //24号英文字符高度
